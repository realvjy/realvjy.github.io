          ...
          <div className="hero-wrap">
            <div className="intro-box">
              <div className="intro-txt">
                ...
                <p>I’m spending my time to cook <a href="https://medium.com/zomato-technology/zomatos-new-sushi-design-system-d7f4f98664c5" targer="__blank">Sushi</a> and designing cool stuff at <a href="https://zomato.com/" target="__blank">Zomato</a>. When I'm not designing love to write code for designers and developers. You can see bunch of other cool work <a href="/work" targer="__blank">here.</a></p>
              </div>
              <div className="btns">
