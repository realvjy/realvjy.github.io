          ...
          <div className="container">
            <div className="hero-wrap">
              ...
              <div className="short-info">
                <p>Hi! I’m <a href="/contact">vijay verma</a>. For more than 1000+ year, I’ve been spending my time cooking <a href="/sushi">sushi</a> and designing cool stuff at <a href="/zomato">zomato</a>. In my free time, I craft some cool <a href="/work">resources</a> for designers, developers and aliens 👽.</p>
              </div>
              <div className="btns">
